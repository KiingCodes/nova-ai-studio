...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 page-brand-bg relative overflow-hidden">
      ...
      >
        ...
        <div className="glass-panel-strong p-6 rounded-2xl space-y-4">
          <button
            onClick={onGoogle}
            disabled={busy}
            className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-secondary hover:bg-muted text-sm font-medium transition-all disabled:opacity-50"
          >
